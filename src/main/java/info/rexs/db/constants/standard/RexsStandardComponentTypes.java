...
public interface RexsStandardComponentTypes {
	...
	/** FKM evaluation point (Versions: 1.4, 1.5) */
	...
	/** Meshing contact stage data of a point list (Versions: 1.4, 1.5) */
	...
	/** Notch effect of shaft-hub-connection (Versions: 1.4, 1.5) */
	...
	/** Rolling bearing with detailed geometry (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
