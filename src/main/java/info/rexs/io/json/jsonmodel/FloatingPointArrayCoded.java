...
public class FloatingPointArrayCoded {
    ...
    public FloatingPointArrayCoded withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public FloatingPointArrayCoded withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public FloatingPointArrayCoded withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(FloatingPointArrayCoded.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
        sb.append(((this.code == null)?nullConstant:this.code));
        sb.append(',');
        sb.append("value");
        sb.append('=');
        sb.append(((this.value == null)?nullConstant:this.value));
        sb.append(',');
