...
public class LoadCase {
    ...
    public LoadCase withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public LoadCase withComponents(List<Component> components) {
        this.components = components;
        return this;
    }
    ...
    public LoadCase withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(LoadCase.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
