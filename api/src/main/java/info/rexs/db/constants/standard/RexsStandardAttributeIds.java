 ...
 * <p>
 * It contains constants for all attribute IDs of official REXS versions (1.0, 1.1, 1.2, 1.3, 1.4, 1.5).
 *
 * @author FVA GmbH
 */
public interface RexsStandardAttributeIds {

	/** Acceleration factor according to FVA 341 (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Actual tangential load (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Addendum coefficient tool reference profile relative to module (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Addendum modification (profile shift) (Versions: 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId addendum_modification = RexsAttributeId.create("addendum_modification", RexsUnitId.mm);

	/** Addendum modification coefficient (profile shift coefficient) (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Addendum modification coefficient (profile shift coefficient) finished gear (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Addendum modification coefficient worm wheel (Versions: 1.3, 1.4, 1.5) */
	...
	/** Addendum reference profile of tool (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Allowable stress number bending (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Allowable stress number for contact stress (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Alternating bending strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Alternating tension/ compression strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Alternating torsional strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Ambient temperature (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Angle of blade sequence (Versions: 1.3, 1.4, 1.5) */
	...
	/** Relative tilting of the inner ring around the v-axis compared to the outer ring. (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Relative tilting of the inner ring around the w-axis compared to the outer ring. (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Angular offset of the mounting position of the outer ring around the v-axis (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Angular offset of the mounting position of the outer ring around the w-axis (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Angular motion coefficients (Versions: 1.3, 1.4, 1.5) */
	...
	/** Angular position around u axis (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Application factor (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Application factor for fatigue load (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** application factor  (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Application factor (ISO 6336 2006) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Estimated strength value design calculation VDI 2736 2014 (Versions: 1.3, 1.4, 1.5) */
	...
	/** Approximated standard deviation of scuffing temperature (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Average surface roughness for filter cutoff length (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Arithmetic average of R_q1x (Pinion) and R_q2x (Gear) at filter cutoff of wavelength (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Arithmetic average roughness flank (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Arithmetic average roughness root (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Averaged linear wear  (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Averaged peak-to-valley height flank (Versions: 1.3, 1.4, 1.5) */
	...
	/** Averaged peak-to-valley height root (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Axial clearance (Versions: 1.5) */
	public static final RexsAttributeId axial_clearance = RexsAttributeId.create("axial_clearance", RexsUnitId.mum);

	/** Axial bearing clearance class (before mounting) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId axial_clearance_class = RexsAttributeId.create("axial_clearance_class", RexsUnitId.none);

	/** Relative displacement of the inner ring in the u-direction compared to the outer ring (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId axial_deflection = RexsAttributeId.create("axial_deflection", RexsUnitId.mum);

	/** Axial displacement of gear (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId axial_displacement_gear = RexsAttributeId.create("axial_displacement_gear", RexsUnitId.mm);

	/** Axial displacement of pinion (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Axial distance between load input and output point (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Axial dynamic load rating (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Maximum axial force (Versions: 1.3, 1.4, 1.5) */
	...
	/** Stress ratio of the axial force (Versions: 1.3, 1.4, 1.5) */
	...
	/** Upper value of axial force (Versions: 1.3, 1.4, 1.5) */
	...
	/** Axial machining allowance (Versions: 1.3, 1.4, 1.5) */
	...
	/** Axial module (Versions: 1.3, 1.4, 1.5) */
	...
	/** Axial pitch (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Axial static load rating (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Base diameter of virtual cylindrical gear in normal section (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Base diameter of virtual cylindrical gear (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Basic factor according to FVA 341 (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Basic crown gear addendum factor (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Basic crown gear dedendum factor (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Basic strength root (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Basis of lubricant (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId basis = RexsAttributeId.create("basis", RexsUnitId.none);

	/** Bearing tolerance class (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Bearing type (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId bearing_type = RexsAttributeId.create("bearing_type", RexsUnitId.none);

	/** Beginning of feather key supporting length (Versions: 1.4, 1.5) */
	...
	/** Tilting stiffness (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Bending strength geometry factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Maximum bending torque (Versions: 1.3, 1.4, 1.5) */
	...
	/** Stress ratio R of the bending moment (Versions: 1.3, 1.4, 1.5) */
	...
	/** Alternating load bending moment, upper value (Versions: 1.3, 1.4, 1.5) */
	...
	/** Bending yield strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Bevel spiral angle factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Calculation method (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Tolerance class of casing bore (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Center roll position (Versions: 1.3, 1.4, 1.5) */
	public static final RexsAttributeId center_roll_position = RexsAttributeId.create("center_roll_position", RexsUnitId.deg);

	/** Central film thickness at the calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Centre distance of virtual cylindrical gear pair (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Cordal height (Versions: 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId chordal_height = RexsAttributeId.create("chordal_height", RexsUnitId.mm);

	/** Chordal tooth thickness between B and D (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Chordal tooth thickness lower deviation (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Chordal tooth thickness upper deviation (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Chordal transverse tooth thickness lower deviation (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Chordal transverse tooth thickness upper  deviation (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Longitudinal coefficient of friction during joining (Versions: 1.4, 1.5) */
	...
	/** Coefficient of adhesion with slipping force in circumferential direction (Versions: 1.4, 1.5) */
	...
	/** Coefficient of adhesion for slipping force in longitudinal direction (Versions: 1.4, 1.5) */
	...
	/** Coefficient of friction &micro; determined according to VDI 2736 2014 (Versions: 1.3, 1.4, 1.5) */
	...
	/** Coefficient of friction (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Combined derating factor (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Combined influence factor bending (Versions: 1.3, 1.4, 1.5) */
	...
	/** Combined influence factor tension/ compression (Versions: 1.3, 1.4, 1.5) */
	...
	/** Combined influence factor torsion (Versions: 1.3, 1.4, 1.5) */
	...
	/** Common face width (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId common_face_width = RexsAttributeId.create("common_face_width", RexsUnitId.mm);

	/** Composite surface roughness for filter cutoff wavelength L_x (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Cone angle error tapered interference fit (Versions: 1.4, 1.5) */
	...
	/** Cone ratio tapered interference fit (Versions: 1.4, 1.5) */
	...
	/** Consequences of damage in case of failure of the component (Versions: 1.4, 1.5) */
	...
	/** Consider centrifugal force (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Consideration of operating temperature (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Consideration of EP additives ISO 281 2007 (Versions: 1.4, 1.5) */
	...
	/** Constant a_d of effective norm diameter for tensile strength (Versions: 1.4, 1.5) */
	...
	/** Constant a_d of effective norm diameter for yield strength (Versions: 1.4, 1.5) */
	...
	/** Contact exposure time at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Contact factor (tooth bending) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Flank contact ratio factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Root contact ratio factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Contact ratio factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Contact pattern ratio from local loaded tooth contact analysis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Contact ratio (Versions: 1.3, 1.4, 1.5) */
	...
	/** Contact stress adjustment factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Contact stress (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Contact stress at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Contamination coefficient according to ISO 281 2007 (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Deviation factor (measuring piece) (Versions: 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId conversion_factor = RexsAttributeId.create("conversion_factor", RexsUnitId.none);

	/** Deviation of base tangent length factor (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Cooling power (Versions: 1.3, 1.4, 1.5) */
	...
	/** Coordinate where amount of modification is specified at datum face (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Coordinate where amount of modification is specified at non-datum face (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Face width coordinates of helix deviations (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Coordinates  of topographical deviation (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Coordinates  of topographical modification (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Outer diameter of circular ring cross section (Versions: 1.4, 1.5) */
	...
	/** Form of cross section on evaluation point (Versions: 1.4, 1.5) */
	...
	/** Crowning of the mating flanks (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Curvature factor at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	public static final RexsAttributeId custom_zf_endurable_tooth_root_stress_limit_for_load_independent_stress_influence_dr14028_2020 = RexsAttributeId.create("custom_zf_endurable_tooth_root_stress_limit_for_load_independent_stress_influence_dr14028_2020", RexsUnitId.mega_pascal);

	/** Customer (Versions: 1.5) */
	public static final RexsAttributeId customer = RexsAttributeId.create("customer", RexsUnitId.none);

	/** Cutter module (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId cutter_module = RexsAttributeId.create("cutter_module", RexsUnitId.mm);

	/** Cutter radius (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId cutter_radius = RexsAttributeId.create("cutter_radius", RexsUnitId.mm);

	/** Cutter swivel (Versions: 1.3, 1.4, 1.5) */
	public static final RexsAttributeId cutter_swivel = RexsAttributeId.create("cutter_swivel", RexsUnitId.deg);

	/** Cutter tilt (Versions: 1.3, 1.4, 1.5) */
	public static final RexsAttributeId cutter_tilt = RexsAttributeId.create("cutter_tilt", RexsUnitId.deg);

	/** Highly loaded surface for the material-mechanical support concept (Versions: 1.4, 1.5) */
	...
	/** Miner variant under cyclic load (Versions: 1.4, 1.5) */
	...
	/** Number of cycles in each cyclic load spectrum step (Versions: 1.4, 1.5) */
	...
	/** Number of steps in cyclic load spectrum (Versions: 1.4, 1.5) */
	...
	/** Overloading type under cyclic load (Versions: 1.4, 1.5) */
	...
	/** Regular inspections under cyclic load (Versions: 1.4, 1.5) */
	...
	/** Number of required cycles in cyclic load spectrum (Versions: 1.4, 1.5) */
	...
	/** Use equivalent mean stress under cyclic load (Versions: 1.4, 1.5) */
	...
	/** Use Stielers support concept under cyclic load (Versions: 1.4, 1.5) */
	...
	/** External data source (Versions: 1.5) */
	public static final RexsAttributeId data_source = RexsAttributeId.create("data_source", RexsUnitId.none);

	/** Orientation datum face (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Dedendum coefficient tool reference profile relative to module (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Dedendum reference profile (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Deformation behavior (Versions: 1.5) */
	public static final RexsAttributeId deformation_behaviour = RexsAttributeId.create("deformation_behaviour", RexsUnitId.none);

	/** Deformation of the tooth tip in circumferential direction (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Degree of tooth loss (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Case hardening depth at 550 HV (Versions: 1.3, 1.4, 1.5) */
	...
	/** Design tooth flank temperature (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Design tooth root temperature  (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Design safety of the tooth flank  (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Design safety of the tooth root  (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of bulk temperature (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of cooling power (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of deflection (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of degree of tooth loss (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of factor K_H for tooth flank loading (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of factor K_F for tooth root loading (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of the load cycle-dependent fatigue strength under pulsating stress (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of flank loss (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of hardness depth profile (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of local Hertzian contact stress (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Method for approximating mean coefficient of friction (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of mean hertzian stress (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of mean minimum lubricant film thickness (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of meshing power loss (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of the temperature-dependant modulus of elasticity (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of oil sump temperature (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of permissible wear erosion (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of the temperature-dependent Poisson's ratio (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of residual stress depth profile (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of the load cycle-dependent rolling contact fatigue strength (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Method of calculating scuffing temperature (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of mean sliding path (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of spiral angle factor Z_&beta; (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of stress correction factor notch effect (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of tooth root safety (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of total efficiency (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of wear coefficient (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Determination of the tmperature-dependant yield strength (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Figure number for contamination coefficient e_C in ISO 281 2007 (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameters of helix deviations (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter of helix modification (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Measuring ball or pin diameter (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter of rolling element (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where amount of profile crowning at the root is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where amount of profile crowning at the tip is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where amount of modification is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where amount of profile twist is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameters of profile deviations (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameters  of topographical deviation (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameters  of topographical modification (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diametral measurement (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId diametral_measurement = RexsAttributeId.create("diametral_measurement", RexsUnitId.mm);

	/** Dimensionless central film thickness at the calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Direction of rotation factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Direction vector of gravity u-coordinate (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Direction vector of gravity v-coordinate (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Direction vector of gravity w-coordinate (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Displacement in u direction at inner side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Displacement in v direction at inner side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Displacement in w direction at inner side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Displacement in u direction at outer side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Displacement in v direction at outer side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Displacement in w direction at outer side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Displacement in u direction (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId displacement_u = RexsAttributeId.create("displacement_u", RexsUnitId.mum);

	/** Axial displacement in u direction (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Displacement in v direction (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId displacement_v = RexsAttributeId.create("displacement_v", RexsUnitId.mum);

	/** Radial displacement in v-direction (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Displacement in w direction (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId displacement_w = RexsAttributeId.create("displacement_w", RexsUnitId.mum);

	/** Radial displacement in w-direction (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Display color (Versions: 1.3, 1.4, 1.5) */
	public static final RexsAttributeId display_color = RexsAttributeId.create("display_color", RexsUnitId.percent);

	/** Distance along the line of action - Point A (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Distance along the line of action - Point B (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Distance along the line of action - Point C (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Distance along the line of action - Point D (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Distance along the line of action - Point E (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Distance along the line of action - Point F (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Distance between bearing rows (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Distance from the centre of the zone of action to a contact line (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Distance from datum line to measuring line (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Distance of tool tip line to manufacturing pitch circle (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Driving direction factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Dynamic factor (AGMA 2101 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Dynamic factor (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Dynamic factor (DIN 3990 1987) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Dynamic factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Dynamic factor (ISO 6336 2006) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Dynamic viscosity at tooth temperature (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** 45&deg; chamfer or rounding on the shaft keyway edge (Versions: 1.4, 1.5) */
	...
	/** Effective diameter (Versions: 1.4, 1.5) */
	...
	/** Effective norm diameter for tensile strength (Versions: 1.4, 1.5) */
	...
	/** Effective norm diameter for yield strength (Versions: 1.4, 1.5) */
	...
	/** Effective face width (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Effective face width of virtual cylindrical gear pair (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Effective face width (Versions: 1.3, 1.4, 1.5) */
	...
	/** Effective pressure angle on coast side (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Effective pressure angle on drive side (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Elasticity factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Elasticity factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Length of end of tangential transition area (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of start of tangential transition area (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Depth of end relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Coordinate where amount of modification is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of end relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Endurance limit flank (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Endurance limit root (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Entraining velocity at the calculation points (Versions: 1.3, 1.4, 1.5) */
	...
	/** Equivalent circumferential force (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Equivalent dynamic bearing load iso 281 2007 (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** (Equivalent) outer diameter of hub (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Equivalent radius of curvature at pitch point (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Equivalent radius of curvature at pitch point under test conditions (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Equivalent effective surface pressure hub (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Equivalent effective surface pressure key (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Equivalent effective surface pressure shaft (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Equivalent torsional torque (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Exponent for the distribution of the load peaks along the lines of contact (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Further extrapolate slope from long life range beyond point L (Versions: 1.4, 1.5) */
	...
	/** Face angle (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId face_angle = RexsAttributeId.create("face_angle", RexsUnitId.deg);

	/** Face apex beyond crossing point (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Face load factor (ISO 6336 2006) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Face width factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Face width of virtual cylindrical gear pair (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Factor d for calculating dynamic viscosity (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Factor for tooth flank loading (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Factor for tooth root loading (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Calculation factor k (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	public static final RexsAttributeId factor_k_plewe_1980 = RexsAttributeId.create("factor_k_plewe_1980", RexsUnitId.none);

	/** Bending stress amplitude of the fatigue strength for a specific mean stress (Versions: 1.3, 1.4, 1.5) */
	...
	/** Fatigue limit under reversed bending stress (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Compression-tension fatigue limit (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Fatigue limit load (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId fatigue_limit_load = RexsAttributeId.create("fatigue_limit_load", RexsUnitId.kilo_newton);

	/** Fatigue limit under reversed torsional stress (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Fatigue strength factor for compression (Versions: 1.4, 1.5) */
	...
	/** Fatigue strength factor for shear (Versions: 1.4, 1.5) */
	...
	/** Fatigue strength under pulsating stress (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tension/ compression stress amplitude of the fatigue strength for a specific mean stress (Versions: 1.3, 1.4, 1.5) */
	...
	/** Torsional stress amplitude of the component fatigue strength for a specific mean stress (Versions: 1.3, 1.4, 1.5) */
	...
	/** Fitting distance (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Flag designation addendum modification (profile shift) (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Flank form (Versions: 1.3, 1.4, 1.5) */
	...
	/** Flank loss from wheel in the normal section (Versions: 1.3, 1.4, 1.5) */
	...
	/** Hertzian flank stress (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Flank surface (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Flash temperature at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Flash temperature at the calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Folder name (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId folder = RexsAttributeId.create("folder", RexsUnitId.none);

	/** Force in u-direction acting on the component on the inner side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Force in v-direction acting on the component on the inner side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Force in w-direction acting on the component on the inner side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Force in u-direction acting on the component on the outer side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Force in v-direction acting on the component on the outer side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Force in w-direction acting on the component on the outer side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Force in u-direction acting on the shaft (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Force in v-direction acting on the shaft (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Force in w-direction acting on the shaft (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Form factor tension/ compression (Versions: 1.3, 1.4, 1.5) */
	...
	/** Form factor (tooth bending) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Form factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Form factor torsion (Versions: 1.3, 1.4, 1.5) */
	...
	/** Form factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Friction connection factor at maximum load (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Gear efficiency in reducer (Versions: 1.3, 1.4, 1.5) */
	...
	/** Gear shift index (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId gear_shift_index = RexsAttributeId.create("gear_shift_index", RexsUnitId.none);

	/** Generated addendum modification coefficient (profile shift coefficient) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Generated addendum modification coefficient (profile shift coefficient) (lower deviation) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Generated addendum modification coefficient (profile shift coefficient) (upper deviation) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Center distance in generating train (Versions: 1.3, 1.4, 1.5) */
	...
	/** Generated pressure angle on coast side (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Generated pressure angle on drive side (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Geometrical size factor bending (Versions: 1.3, 1.4, 1.5) */
	...
	/** Geometrical size factor tension/ compression (Versions: 1.3, 1.4, 1.5) */
	...
	/** Geometrical size factor torsion (Versions: 1.3, 1.4, 1.5) */
	...
	/** Gravitational acceleration (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Half width of contact area (Versions: 1.3, 1.4, 1.5) */
	...
	/** Hardness conversion factor (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Heat transfer coefficient at the surface of the bearing seat (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Plastic gear flank heat transfer coefficient (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Plastic gear root heat transfer coefficient  (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Heat transfer resistance (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Heat treated material type (ISO 6336 2006) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Helical motion coefficients (Versions: 1.3, 1.4, 1.5) */
	...
	/** Helix angle at the base circle (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Helix angle factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Helix angle at reference circle (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Amount of helix crowning at datum face (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Amount of helix crowning at non-datum face (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Hub safety against plastic deformation at equivalent torque (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Hub safety against plastic deformation at maximum torque (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Hypoid factor pitting (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Inclination exponent of the S-N curve in limited life (Versions: 1.4, 1.5) */
	...
	/** Inclination exponent of the S-N curve in long life (Versions: 1.4, 1.5) */
	...
	/** Increase factor yield strength bending (Versions: 1.3, 1.4, 1.5) */
	...
	/** Increase factor yield strength tension/ compression (Versions: 1.3, 1.4, 1.5) */
	...
	/** Increase factor yield strength torsion (Versions: 1.3, 1.4, 1.5) */
	...
	/** Inertia factor for bending stress (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Modification is additive (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Adequate gear tip profile modification (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Is austenitic and solution-annealed material (Versions: 1.4, 1.5) */
	...
	/** Is austenitic steel (Versions: 1.4, 1.5) */
	...
	/** Is hardable material (Versions: 1.4, 1.5) */
	...
	/** Joint diameter of joint section (Versions: 1.4, 1.5) */
	...
	/** Joint pressure (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Feather key safety against plastic deformation at equivalent torque (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Feather key safety against plastic deformation at maximum torque (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Klingelnberg 3d neutral data file (Versions: 1.3, 1.4, 1.5) */
	...
	/** Klingelnberg neutral data file (Versions: 1.3, 1.4, 1.5) */
	...
	/** Large outer diameter with shouldered hub (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Lead factor (tooth bending) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Length of profile deviations (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of rolling element (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of tip path of contact (Versions: 1.3, 1.4, 1.5) */
	...
	/** Length  of topographical modification (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length where amount of profile crowning at the rootis specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length where amount of profile crowning at the tip is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Life factor (pitting) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Life factor pitting (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Life factor (tooth bending) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Life factor tooth root (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Limit temperature according to standard scuffing tests (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Linear wear coefficient under test conditions (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Load angle at tip (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId load_angle_at_tip = RexsAttributeId.create("load_angle_at_tip", RexsUnitId.deg);

	/** Load-bearing factor for equivalent load (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Load-bearing factor for maximum load (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Load carrying face width (Versions: 1.3, 1.4, 1.5) */
	...
	/** Load cycles dependent fatigue strength under pulsating stress (Versions: 1.3, 1.4, 1.5) */
	...
	/** Load cycles dependent rolling contact fatigue strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Load cycles variation for fatigue strength under pulsating stress (Versions: 1.3, 1.4, 1.5) */
	...
	/** Load cycles variation for rolling contact fatigue strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Load dependent power losses (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Load distribution along common face width (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Load distribution factor (AGMA 2101 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Load distribution factor (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Load distribution factor (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Node positions of load distribution along common face width (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Load parameter for central film thickness of calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Load safety factor (Versions: 1.4, 1.5) */
	...
	/** Load sharing factor at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Load sharing factor of calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Load sharing factor pitting (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Load sharing factor tooth root (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Local coefficient of friction (Versions: 1.4, 1.5) */
	...
	/** Cyclic local degree of utilization in first principal stress direction (Versions: 1.4, 1.5) */
	...
	/** Cyclic local degree of utilization in second principal stress direction (Versions: 1.4, 1.5) */
	...
	/** Cyclic local degree of utilization in third principal stress direction (Versions: 1.4, 1.5) */
	...
	/** Cyclic local degree of utilization (Versions: 1.4, 1.5) */
	...
	/** Stress tensor of the cyclic load spectrum (Versions: 1.4, 1.5) */
	...
	/** Cyclic local safety factor in first principal stress direction (Versions: 1.4, 1.5) */
	...
	/** Cyclic local safety factor in second principal stress direction (Versions: 1.4, 1.5) */
	...
	/** Cyclic local safety factor in third principal stress direction (Versions: 1.4, 1.5) */
	...
	/** Cyclic local safety factor (Versions: 1.4, 1.5) */
	...
	/** Distance between the two tensors passed to calculate the stress gradient (Versions: 1.4, 1.5) */
	...
	/** Stress ratio of principle stresses in cyclic load spectrum (Versions: 1.4, 1.5) */
	...
	/** Stress tensor inside the component for stress gradient calculation (Versions: 1.4, 1.5) */
	...
	/** Stress tensor at the component surface for stress gradient calculation (Versions: 1.4, 1.5) */
	...
	/** Local flash temperature acc. Blok (1937) (Versions: 1.4, 1.5) */
	...
	/** Local Hertzian contact stress (Versions: 1.4, 1.5) */
	...
	/** Local  load-free backlash (Versions: 1.4, 1.5) */
	...
	/** Local normal line load (Versions: 1.4, 1.5) */
	...
	/** Local relative lubricant film thickness (Versions: 1.4, 1.5) */
	...
	/** Local root stress under peak torque (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Local safety factor for bending stress against breakage (FVA 411) (Versions: 1.4, 1.5) */
	...
	/** Local safety factor for micro pitting  (FVA 516) (Versions: 1.4, 1.5) */
	...
	/** Local safety factor for contact stress against pitting (FVA 411) (Versions: 1.4, 1.5) */
	...
	/** Local safety factor for scuffing  (FVA 519) (Versions: 1.4, 1.5) */
	...
	/** Local safety factor scuffing at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Local sliding velocity (Versions: 1.4, 1.5) */
	...
	/** Static local degree of utilization (Versions: 1.4, 1.5) */
	...
	/** Static local degree of utilization for high stress multiaxiality (Versions: 1.4, 1.5) */
	...
	/** Local limit load factor for the static strength calculation (Versions: 1.4, 1.5) */
	...
	/** Method for local limit load factor for the static strength calculation (Versions: 1.4, 1.5) */
	...
	/** Static local safety factor (Versions: 1.4, 1.5) */
	...
	/** Static local safety factor for high stress multiaxiality (Versions: 1.4, 1.5) */
	...
	/** Local stress tensor for the static strength calculation (Versions: 1.4, 1.5) */
	...
	/** Local sum of damage related to pitting  (FVA 411) (Versions: 1.4, 1.5) */
	...
	/** Local surface velocity (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Local surface velocity in profile direction at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Local tooth root stress (Versions: 1.4, 1.5) */
	...
	/** Local tooth root stress (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Longitudinal load factor pitting (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Longitudinal load factor tooth root (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Lower diametric deviation (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Lower base tangent length deviation (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Lower centre distance allowance (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Lubricant factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Lubricant factor (pitting) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Lubricant film thickness parameter (Versions: 1.3, 1.4, 1.5) */
	...
	/** Oil volume flow rate through bearing (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Lubricant structure factor (Versions: 1.3, 1.4, 1.5) */
	...
	/** Difference of oil temperatures between outflow and feed (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Lubricant type (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Lubricant type (ISO 6336 2006) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Coefficient for lubrication method (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId lubrication_factor = RexsAttributeId.create("lubrication_factor", RexsUnitId.none);

	/** Lubrication factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Lubrication type (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Type of lubrication (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Machining allowance tolerance (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Material category (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Material constant a_G for Stieler support concept FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Material constant b_G for Stieler support concept FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Material depth dependent hardness (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Material depth dependent residual stress (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Material depth variation for hardness (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Material depth variation for residual stress (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Material designation (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId material_designation = RexsAttributeId.create("material_designation", RexsUnitId.none);

	/** Material exposure calibration factor (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Material factor (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Hardening method (Versions: 1.4, 1.5) */
	...
	/** Material loss (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Material loss limit (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Material - lubricant factor (Versions: 1.3, 1.4, 1.5) */
	...
	/** Shear fatigue strength FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Tensile fatigue strength FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Torsion fatigue strength FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Material type (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Material type (DIN 743 2012) (Versions: 1.4, 1.5) */
	...
	/** Reduced stiffness matrix with boundary condition to inertial environment (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum actual reference tooth thickness (Versions: 1.4, 1.5) */
	...
	/** Maximum actual space width (Versions: 1.4, 1.5) */
	...
	/** Permissible pressure in the bearing (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Maximum axial bearing clearance (before mounting) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Maximum diameter of bearing bore (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Maximum bearing outer diameter (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Maximum diameter of casing bore (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Maximum circumferential force (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Maximum effective cone diameter joint tapered interference fit (Versions: 1.4, 1.5) */
	...
	/** Maximum contact temperature (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum distance to middle contact line (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Maximum distance to middle contact line at left side of contact pattern (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Maximum distance to middle contact line at right side of contact pattern (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Maximum effective tooth thickness (Versions: 1.4, 1.5) */
	...
	/** Max flash temperature (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum flash temperature of test gears (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum pressure (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum pressure at inner ring (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum pressure at outer ring (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum value of hertzian stress from local loaded tooth contact analysis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum material exposure (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum nominal static normal stress due to bending moment around v direction (Versions: 1.4, 1.5) */
	...
	/** Maximum nominal static normal stress due to bending moment around w direction (Versions: 1.4, 1.5) */
	...
	/** Maximum nominal static normal stress due to tension-compression force in u direction (Versions: 1.4, 1.5) */
	...
	/** Maximum nominal static shear stress due to shear force in v direction (Versions: 1.4, 1.5) */
	...
	/** Maximum nominal static shear stress due to shear forces in w direction (Versions: 1.4, 1.5) */
	...
	/** Maximum nominal static shear stress due to torsion moment in u direction (Versions: 1.4, 1.5) */
	...
	/** Maximum permissible material exposure (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum radial bearing clearance (before mounting) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Maximum root circle diameter (Versions: 1.4, 1.5) */
	...
	/** Maximum root strength (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum shaft diameter (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId maximum_shaft_diameter = RexsAttributeId.create("maximum_shaft_diameter", RexsUnitId.mm);

	/** Maximum value of sliding velocity from local loaded tooth contact analysis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum stress bending (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum stress tension/ compression (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum stress torsion (Versions: 1.3, 1.4, 1.5) */
	...
	/** Maximum effective surface pressure hub (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Maximum effective surface pressure key (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Maximum effective surface pressure shaft (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Maximum tip circle diameter (Versions: 1.4, 1.5) */
	...
	/** Maximum tip clearance (Versions: 1.4, 1.5) */
	...
	/** Maximum tip diameter (Versions: 1.5) */
	public static final RexsAttributeId maximum_tip_diameter = RexsAttributeId.create("maximum_tip_diameter", RexsUnitId.mm);

	/** Maximum torsional torque in reverse direction (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Maximum transverse backlash (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Upper backlash variation in transverse section (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Maximum value of minimum lubricant film thickness from local loaded tooth contact analysis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean addendum (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId mean_addendum = RexsAttributeId.create("mean_addendum", RexsUnitId.mm);

	/** Average of pinion and gear average roughness  (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean coefficient of friction at the calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean coefficient of friction (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean value of hertzian stress from local loaded tooth contact analysis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean minimum lubricant film thickness for wear (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Mean value of minimum lubricant film thickness from local loaded tooth contact analysis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean normal chordal tooth thickness (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Mean normal circular tooth thickness (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Mean operating temperature (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Mean operating temperature of inner ring (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Mean operating temperature of outer ring (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Mean sliding path (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Mean value of sliding velocity from local loaded tooth contact analysis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean specific sliding at point A (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean specific sliding at point E (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean specific sliding (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean specific sliding under test conditions (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean stress tension/compression (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean stress torsion (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean coefficient of friction (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mean tooth root thickness (DIN 3996 2019) with wear (Versions: 1.4, 1.5) */
	...
	/** Mean tooth root thickness (DIN 3996 2019) without wear (Versions: 1.4, 1.5) */
	...
	/** Mean transverse circular thickness (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Measurement b_z0 of the tool (Versions: 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId measurement_bz0 = RexsAttributeId.create("measurement_bz0", RexsUnitId.mm);

	/** Measuring diameter root undercut (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Contact circle diameter (upper deviation) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Contact circle diameter (ball/flank) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Contact circle diameter for span measurement (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Mesh load factor (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mesh stiffness for load distribution along face width (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Meshing power loss (Versions: 1.3, 1.4, 1.5) */
	...
	/** Mesh stiffness for each mesh position (Versions: 1.5) */
	public static final RexsAttributeId meshing_stiffness_characteristic = RexsAttributeId.create("meshing_stiffness_characteristic", RexsUnitId.newton_per_mm);

	/** Mid zone factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Minimum actual reference space width (Versions: 1.4, 1.5) */
	...
	/** Minimum actual tooth thickness (Versions: 1.4, 1.5) */
	...
	/** Minimum axial bearing clearance (before mounting) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Minimum diameter of bearing bore (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Minimum outer bearing diameter (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Minimum diameter of casing bore (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Minimum contact length (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Minimum grinding diameter at the gear (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId minimum_diameter = RexsAttributeId.create("minimum_diameter", RexsUnitId.mm);

	/** Minimum effective space width (Versions: 1.4, 1.5) */
	...
	/** Minimum film thickness (according to Dowson and Toyoda) (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Minimum value of hertzian stress from local loaded tooth contact analysis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Minimum lubricating film thickness in the pitch point (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Normal module design calculation VDI 2738 2014 (Versions: 1.3, 1.4, 1.5) */
	...
	/** Minimum radial bearing clearance (before mounting) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Minimum root circle diameter (Versions: 1.4, 1.5) */
	...
	/** Minimum safety factor for bending stress (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Minimum safety factor for contact stress (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Minimum safety factor scuffing (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Minimum shaft diameter (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId minimum_shaft_diameter = RexsAttributeId.create("minimum_shaft_diameter", RexsUnitId.mm);

	/** Minimum value of sliding velocity from local loaded tooth contact analysis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Minimum specific film thickness (according to Wellauer and Holloway) (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Minimum pinion diameter design calculation VDI 2738 2014 (Versions: 1.3, 1.4, 1.5) */
	...
	/** Minimum thickness by tip chamfer relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Minimum tip circle diameter (Versions: 1.4, 1.5) */
	...
	/** Minimum tip clearance (Versions: 1.4, 1.5) */
	...
	/** Minimum tip diameter (Versions: 1.5) */
	public static final RexsAttributeId minimum_tip_diameter = RexsAttributeId.create("minimum_tip_diameter", RexsUnitId.mm);

	/** Minimum transverse backlash (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Lower backlash variation in transverse section (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Minimum value of minimum lubricant film thickness from local loaded tooth contact analysis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Radial offset of the mounting position of the outer ring in the v-direction (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Radial offset of the mounting position of the outer ring in the w-direction (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Model name (Versions: 1.5) */
	public static final RexsAttributeId model_name = RexsAttributeId.create("model_name", RexsUnitId.none);

	/** Modification date (Versions: 1.5) */
	public static final RexsAttributeId modification_date = RexsAttributeId.create("modification_date", RexsUnitId.none);

	/** Modified contact stress at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Modified reference rating life DIN 26281 2010 (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Modified roll coefficients (Versions: 1.3, 1.4, 1.5) */
	...
	/** Modulus of elasticity flank at operating temperature (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Modulus of elasticity root at operating temperature (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Moment of inertia around u-axis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Moment of inertia around v-axis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Moment of inertia around w-axis (Versions: 1.3, 1.4, 1.5) */
	...
	/** Axial bearing clearance (after mounting) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Radial bearing clearance (after mounting) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Mounting factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Name of lubricant (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId name = RexsAttributeId.create("name", RexsUnitId.none);

	/** Nominal contact stress (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic degree of utilization of all loads combined (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic degree of utilization of bending moment around v direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic degree of utilization of bending moment around w direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic degree of utilization of shear force in v direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic degree of utilization of shear force in w direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic degree of utilization of tension-compression force in u direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic degree of utilization of torsion moment in u direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic global stress gradient (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic global shear stress gradient (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic local normal stress gradient (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic local shear stress gradient (Versions: 1.4, 1.5) */
	...
	/** Notch factor for nominal cyclic normal stress due to bending moment around v direction (Versions: 1.4, 1.5) */
	...
	/** Notch factor for nominal cyclic normal stress due to bending moment around w direction (Versions: 1.4, 1.5) */
	...
	/** Notch factor for nominal cyclic normal stress due to tension-compression force in u direction (Versions: 1.4, 1.5) */
	...
	/** Notch factor of probe for nominal cyclic normal stress due to bending moment around v direction (Versions: 1.4, 1.5) */
	...
	/** Notch factor of probe for nominal cyclic normal stress due to bending moment around w direction (Versions: 1.4, 1.5) */
	...
	/** Notch factor of probe for nominal cyclic normal stress due to tension-compression force in u direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic normal stress maxima due to bending moments around v direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic normal stress maxima due to bending moments around w direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic normal stress maxima due to tension-compression forces in u direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic normal stress ratio due to bending moment around v direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic normal stress ratio due to bending moment around w direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic normal stress ratio due to tension compression forces in u direction (Versions: 1.4, 1.5) */
	...
	/** Notch factor for nominal cyclic shear stress due to shear force in v direction (Versions: 1.4, 1.5) */
	...
	/** Notch factor for nominal cyclic shear stress due to shear force in w direction (Versions: 1.4, 1.5) */
	...
	/** Notch factor for nominal cyclic shear stress due to torsion moment in u direction (Versions: 1.4, 1.5) */
	...
	/** Notch factor of probe for nominal cyclic shear stress due to shear force in v direction (Versions: 1.4, 1.5) */
	...
	/** Notch factor of probe for nominal cyclic shear stress due to shear force in w direction (Versions: 1.4, 1.5) */
	...
	/** Notch factor of probe for nominal cyclicshear stress due to torsion moment in u direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic shear stress maxima due to shear forces in v direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic shear stress maxima due to shear forces in w direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic shear stress maxima due to torsion moments around u direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic shear stress ratio due to shear force in v direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic shear stress ratio due to shear force in w direction (Versions: 1.4, 1.5) */
	...
	/** Nominal cyclic shear stress ratio due to torsion moment around u direction (Versions: 1.4, 1.5) */
	...
	/** Nominal design pressure angle on coast side (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Nominal design pressure angle on drive side (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Stress concentration factor for nominal normal stress due to bending moment around v direction (Versions: 1.4, 1.5) */
	...
	/** Stress concentration factor for nominal normal stress due to bending moment around w direction (Versions: 1.4, 1.5) */
	...
	/** Stress concentration factor for nominal normal stress due to tension-compression force in u direction (Versions: 1.4, 1.5) */
	...
	/** Nominal rating life ISO 281 2007 (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Nominal reference rating life DIN 26281 (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Stress concentration factor for nominal shear stress due to shear force in v direction (Versions: 1.4, 1.5) */
	...
	/** Stress concentration factor for nominal shear stress due to shear force in w direction (Versions: 1.4, 1.5) */
	...
	/** Stress concentration factor for nominal shear stress due to torsion moment in u direction (Versions: 1.4, 1.5) */
	...
	/** Nominal static degree of utilization of all loads combined (Versions: 1.4, 1.5) */
	...
	/** Nominal static degree of utilization of bending moment around v direction (Versions: 1.4, 1.5) */
	...
	/** Nominal static degree of utilization of bending moment around w direction (Versions: 1.4, 1.5) */
	...
	/** Nominal static degree of utilization of shear force in v direction (Versions: 1.4, 1.5) */
	...
	/** Nominal static degree of utilization of shear force in w direction (Versions: 1.4, 1.5) */
	...
	/** Nominal static degree of utilization of tension-compression force in u direction (Versions: 1.4, 1.5) */
	...
	/** Nominal static degree of utilization of torsion moment in u direction (Versions: 1.4, 1.5) */
	...
	/** Is maximum static bending stress on the tension side (Versions: 1.4, 1.5) */
	...
	/** Nominal static plastic support factor due to bending moment about v-direction (Versions: 1.4, 1.5) */
	...
	/** Nominal static plastic support factor due to bending moment about w-direction (Versions: 1.4, 1.5) */
	...
	/** Nominal static plastic support factor due to torsional moment about u-direction (Versions: 1.4, 1.5) */
	...
	/** Nominal tangential force at base circle (Versions: 1.3, 1.4, 1.5) */
	...
	/** Nominal tangential force at reference circle (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Nominal torsional torque (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Normal module (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId normal_module = RexsAttributeId.create("normal_module", RexsUnitId.mm);

	/** Normal operating load (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Normal radius of curvature at point B (Versions: 1.4, 1.5) */
	...
	/** Normal radius of curvature at point C (Versions: 1.4, 1.5) */
	...
	/** Normal radius of curvature at point d (Versions: 1.4, 1.5) */
	...
	/** Normal radius of curvature at point E (Versions: 1.4, 1.5) */
	...
	/** Normal radius of relative curvature at point A (Versions: 1.4, 1.5) */
	...
	/** Normal radius of relative curvature at point B (Versions: 1.4, 1.5) */
	...
	/** Normal radius of relative curvature at point C (Versions: 1.4, 1.5) */
	...
	/** Normal radius of relative curvature at point D (Versions: 1.4, 1.5) */
	...
	/** Normal radius of relative curvature at point E (Versions: 1.4, 1.5) */
	...
	/** Normal relative radius of curvature of calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Normal space width at reference diameter (Versions: 1.5) */
	public static final RexsAttributeId normal_space_width_at_reference_diameter = RexsAttributeId.create("normal_space_width_at_reference_diameter", RexsUnitId.mm);

	/** Normal space width (Versions: 1.4, 1.5) */
	...
	/** Normal tip thickness for A_We (Versions: 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId normal_tip_thickness = RexsAttributeId.create("normal_tip_thickness", RexsUnitId.mm);

	/** Normal tooth thickness at active root diameter (Versions: 1.5) */
	public static final RexsAttributeId normal_tooth_thickness_at_active_root_diameter = RexsAttributeId.create("normal_tooth_thickness_at_active_root_diameter", RexsUnitId.mm);

	/** Normal tooth thickness at active tip diameter (Versions: 1.5) */
	public static final RexsAttributeId normal_tooth_thickness_at_active_tip_diameter = RexsAttributeId.create("normal_tooth_thickness_at_active_tip_diameter", RexsUnitId.mm);

	/** Normal tooth thickness at pitch diameter (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Normal tooth thickness at reference diameter (Versions: 1.5) */
	public static final RexsAttributeId normal_tooth_thickness_at_reference_diameter = RexsAttributeId.create("normal_tooth_thickness_at_reference_diameter", RexsUnitId.mm);

	/** Normal tooth thickness at root diameter (Versions: 1.5) */
	public static final RexsAttributeId normal_tooth_thickness_at_root_diameter = RexsAttributeId.create("normal_tooth_thickness_at_root_diameter", RexsUnitId.mm);

	/** Normal tooth thickness at root form diameter (Versions: 1.5) */
	public static final RexsAttributeId normal_tooth_thickness_at_root_form_diameter = RexsAttributeId.create("normal_tooth_thickness_at_root_form_diameter", RexsUnitId.mm);

	/** Normal tooth thickness at tip diameter (Versions: 1.5) */
	public static final RexsAttributeId normal_tooth_thickness_at_tip_diameter = RexsAttributeId.create("normal_tooth_thickness_at_tip_diameter", RexsUnitId.mm);

	/** Normal tooth thickness at tip form diameter (Versions: 1.5) */
	public static final RexsAttributeId normal_tooth_thickness_at_tip_form_diameter = RexsAttributeId.create("normal_tooth_thickness_at_tip_form_diameter", RexsUnitId.mm);

	/** Normal unit load (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Notch calculation position (Versions: 1.4, 1.5) */
	...
	/** Notch factor bending (Versions: 1.3, 1.4, 1.5) */
	...
	/** Notch factor tension/ compression (Versions: 1.3, 1.4, 1.5) */
	...
	/** Notch factor torsion (Versions: 1.3, 1.4, 1.5) */
	...
	/** Bore radius (Versions: 1.3, 1.4, 1.5) */
	...
	/** Notch width (Versions: 1.3, 1.4, 1.5) */
	public static final RexsAttributeId notch_width = RexsAttributeId.create("notch_width", RexsUnitId.mm);

	/** Number of load cycles at the point between limited life and long life (Versions: 1.4, 1.5) */
	...
	/** Number of load cycles at the point between static and limited life (Versions: 1.4, 1.5) */
	...
	/** Number of load cycles at the point within limited life (Versions: 1.4, 1.5) */
	...
	/** Number of load cycles at the point within long life (Versions: 1.4, 1.5) */
	...
	/** Number of load cycles at the point within static range (Versions: 1.4, 1.5) */
	...
	/** Number of calculation points along the line of contact (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Number of load peaks during operation (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Number of nodes in mesh width for load distribution (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Number of points in y-direction (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Number of rolling elements (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Number of teeth (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId number_of_teeth = RexsAttributeId.create("number_of_teeth", RexsUnitId.none);

	/** Measured number of teeth for base tangent length W_k (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Oil inlet or sump temperature (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Calculated oil sump temperature (Versions: 1.3, 1.4, 1.5) */
	...
	/** Operating axial bearing clearance (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating helix angle (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_u / &part;d_u (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_u / &part;d_v (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_u / &part;d_w (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_u / &part;rot_v (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_u / &part;rot_w (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_v / &part;d_u (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_v / &part;d_v (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_v / &part;d_w (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_v / &part;rot_v (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_v / &part;rot_w (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness  &part;F_w / &part;d_u (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_w / &part;d_v (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_w / &part;d_w (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_w / &part;rot_v (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;F_w / &part;rot_w (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;M_v / &part;d_u (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;M_v / &part;d_v (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;M_v / &part;d_w (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;M_v / &part;rot_v (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;M_v / &part;rot_w (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;M_w / &part;d_u (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;M_w / &part;d_v (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;M_w / &part;d_w (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;M_w / &part;rot_v (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating point stiffness &part;M_w / &part;rot_w (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating pressure angle (Versions: 1.3, 1.4, 1.5) */
	...
	/** Operating pressure angle in the normal section (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating pressure angle in the transverse section (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Operating radial bearing clearance (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Desired service life for VDI 2736 2014 design calculation (Versions: 1.3, 1.4, 1.5) */
	...
	/** Outer diameter (Versions: 1.3, 1.4, 1.5) */
	...
	/** Overload factor (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Overrolling frequency inner ring (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Overrolling frequency outer ring (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Overrolling frequency rolling element (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Parameter a_a for hardness according to method C2 (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Parameter a_b  for hardness according to method C2 (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Parameter A  for hardness according to method C2 (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Parameter b_a  for hardness according to method C2 (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Parameter b_b  for hardness according to method C2 (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Parameter B  for hardness according to method C2 (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Parameter c_a  for hardness according to method C2 (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Parameter c_b  for hardness according to method C2 (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Parameter C  for hardness according to method C2 (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Parameter for calculating gear tooth temperature (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Parameter for mean minimum lubricant film thickness (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Parameter k for calculating pressure-viscosity coefficient (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Parameter for the mean hertzian stress (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Parameter for the mean sliding path (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Parameter s for calculating pressure-viscosity coefficient (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Part number (Versions: 1.5) */
	public static final RexsAttributeId part_number = RexsAttributeId.create("part_number", RexsUnitId.none);

	/** Additional safety factor for castings (Versions: 1.4, 1.5) */
	...
	/** Partial contact ratio of tip path of contact (Versions: 1.3, 1.4, 1.5) */
	public static final RexsAttributeId partial_contact_ratio = RexsAttributeId.create("partial_contact_ratio", RexsUnitId.none);

	/** Partial contact ratio (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Peak circumferential force at reference circle (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Peak torque (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Permissible change to the circumferential backlash (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Permissible contact stress (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Permissible equivalent surface pressure hub (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Permissible equivalent surface pressure key (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Permissible equivalent surface pressure shaft (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Permissible flank pressure (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Permissible joining temperature hub (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Permissible linear wear (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Permissible local root stress under peak torque (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Permissible maximum surface pressure hub (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Permissible maximum surface pressure key (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Permissible maximum surface pressure shaft (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Permissible root stress (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Permissible scuffing temperature (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Permissible stress at the point between limited life and long life (Versions: 1.4, 1.5) */
	...
	/** Permissible stress at the point between static and limited life (Versions: 1.4, 1.5) */
	...
	/** Permissible stress at the point within limited life (Versions: 1.4, 1.5) */
	...
	/** Permissible stress at the point within long life (Versions: 1.4, 1.5) */
	...
	/** Permissible stress at the point within static range (Versions: 1.4, 1.5) */
	...
	/** Permissible temperature (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Permissible tooth root stress (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Permissible wear erosion (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Permissible wear mass (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Pitch angle (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId pitch_angle = RexsAttributeId.create("pitch_angle", RexsUnitId.deg);

	/** Pitch apex beyond crossing point (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Pitch circle diameter (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId pitch_diameter = RexsAttributeId.create("pitch_diameter", RexsUnitId.mm);

	/** Pitting resistance geometry factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Point of maximum material exposure (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Poisson's ratio (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId poisson_ratio = RexsAttributeId.create("poisson_ratio", RexsUnitId.none);

	/** Poisson's ratio at operating temperature (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Face width coordinate of profile deviations (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Face width coordinate of the profile modification (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Facewidth coordinate of the profile twist modification on datum face (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Facewidth coordinate of the profile twist modification on non-datum face (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Position of rolling elements (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Power with sign (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId power = RexsAttributeId.create("power", RexsUnitId.kilo_watt);

	/** Rolling output (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Power (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Pressure angle in the transverse section (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Pressure angle (Versions: 1.3, 1.4, 1.5) */
	...
	/** Pressure factor (Versions: 1.3, 1.4, 1.5) */
	...
	/** Pressure viscosity coefficient (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Pressure-viscosity coefficient at 38 &deg;C (Versions: 1.3, 1.4, 1.5) */
	...
	/** Probability of scuffing (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Probability of wear (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Amount of profile crowning at the root (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** End diameter of profile evaluation (Versions: 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId profile_evaluation_end = RexsAttributeId.create("profile_evaluation_end", RexsUnitId.mm);

	/** Profile control diameter (start of evaluation) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter of highest point in profile (Versions: 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId profile_highest_point = RexsAttributeId.create("profile_highest_point", RexsUnitId.mm);

	/** Profile line length of the active tooth flank (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Profile modification (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Profile control diameter (start of evaluation) of the profile twist (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Protuberance amount (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId protuberance_amount = RexsAttributeId.create("protuberance_amount", RexsUnitId.mm);

	/** Protuberance amount factor (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Protuberance height factor (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Protuberance radius (Versions: 1.3, 1.4, 1.5) */
	...
	/** Radius of raceway at inner ring (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Radius of raceway at outer ring (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Radial bearing clearance (before mounting) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Radial clearance (Versions: 1.5) */
	public static final RexsAttributeId radial_clearance = RexsAttributeId.create("radial_clearance", RexsUnitId.mum);

	/** Radial bearing clearance class (before mounting) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId radial_clearance_class = RexsAttributeId.create("radial_clearance_class", RexsUnitId.none);

	/** Radial contact ratio (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId radial_contact_ratio = RexsAttributeId.create("radial_contact_ratio", RexsUnitId.none);

	/** Relative displacement of the inner ring in the v-direction compared to the outer ring (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId radial_deflection_in_v = RexsAttributeId.create("radial_deflection_in_v", RexsUnitId.mum);

	/** Relative displacement of the inner ring in the w-direction compared to the outer ring (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId radial_deflection_in_w = RexsAttributeId.create("radial_deflection_in_w", RexsUnitId.mum);

	/** Radial distance (Versions: 1.3, 1.4, 1.5) */
	public static final RexsAttributeId radial_distance = RexsAttributeId.create("radial_distance", RexsUnitId.mm);

	/** Radial dynamic load rating (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Radial motion coefficients (Versions: 1.3, 1.4, 1.5) */
	...
	/** Radial static load rating (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Radius of curvature at Point E (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Rakeface inclination angle (Versions: 1.3, 1.4, 1.5) */
	...
	/** Reduced modulus of elasticity (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Reduced static stiffness matrix (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Reference circle diameter (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Reference component for position (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Reference diameter (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Reference diameter (DIN 5480 2006) (Versions: 1.4, 1.5) */
	...
	/** Reference diameter of virtual cylindrical gear in normal section (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Reference diameter of virtual cylindrical gear (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Reference diameter (Versions: 1.3, 1.4, 1.5) */
	...
	/** Thermal reference speed (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId reference_speed = RexsAttributeId.create("reference_speed", RexsUnitId.rotation_per_min);

	/** Reference temperature (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Reference wear intensity (Versions: 1.3, 1.4, 1.5) */
	...
	/** Id of referenced component (Versions: 1.5) */
	public static final RexsAttributeId referenced_component_id = RexsAttributeId.create("referenced_component_id", RexsUnitId.none);

	/** Related tip thickness (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId related_tip_thickness = RexsAttributeId.create("related_tip_thickness", RexsUnitId.none);

	/** Relativ surface factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Distance from datum line to measuring line relative to the normal module (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Relative duty cycle (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Lever arm for load at tip to 30 degree tangent (relative to module) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Machining allowance of the tool according to DIN 3972 (relative to the normal module) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Relative material structure factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Tool b_z0* measurement (relative to module) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Tooth root chord at the 30&deg; tangent (relative to module) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Tooth root radius at the 30&deg; tangent (relative to module) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Remaining protuberance (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId remaining_protuberance = RexsAttributeId.create("remaining_protuberance", RexsUnitId.mm);

	/** Required minimum tooth flank safety factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Required tooth root minimum safety factor (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Required minimum tooth root safety factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Required minimum safety factor for exceeding the yield strength (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Revision number (Versions: 1.5) */
	public static final RexsAttributeId revision_number = RexsAttributeId.create("revision_number", RexsUnitId.none);

	/** Rim thickness factor (tooth bending) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Rolling contact fatigue strength (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Contact type (Versions: 1.3, 1.4, 1.5) */
	...
	/** Coordinates on rolling element (Versions: 1.3, 1.4, 1.5) */
	...
	/** Rolling element force (Versions: 1.3, 1.4, 1.5) */
	...
	/** Rolling element lamina load (Versions: 1.3, 1.4, 1.5) */
	...
	/** Rolling element pressure (Versions: 1.3, 1.4, 1.5) */
	...
	/** Rolling element torque (Versions: 1.3, 1.4, 1.5) */
	...
	/** Rolling length where amount of modification is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Rolling length where amount of profile twist is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Rolling rotational speed (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Rolling tangential velocity at the calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Root angle (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId root_angle = RexsAttributeId.create("root_angle", RexsUnitId.deg);

	/** Root apex beyond crossing point (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Root diameter (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Root diameter of virtual cylindrical gear (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Diameter at start of root relief (reference diameter) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of root relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Depth of root relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId root_relief_depth = RexsAttributeId.create("root_relief_depth", RexsUnitId.mm);

	/** Diameter where tangential transition area ends (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where tangential transition area starts (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length where amount of modification is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of tangential transition area end (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of tangential transition area start (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Root stress adjustment factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Root stress (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Root temperature (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Rotating angle around u-axis (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Rotational meshing positions (Versions: 1.5) */
	public static final RexsAttributeId rotational_meshing_position = RexsAttributeId.create("rotational_meshing_position", RexsUnitId.deg);

	/** Rotational speed with sign (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId rotational_speed = RexsAttributeId.create("rotational_speed", RexsUnitId.rotation_per_min);

	/** Torsional stiffness (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Roughness depth of joining surface inner part (Versions: 1.4, 1.5) */
	...
	/** Roughness depth of joining surface outer part (Versions: 1.4, 1.5) */
	...
	/** Roughness factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Running-in factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Safety against beginning plasticity hub (maximum distortion criterion) (Versions: 1.4, 1.5) */
	...
	/** Safety against beginning plasticity shaft  (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Safety against beginning plasticity shaft (maximum distortion criterion) (Versions: 1.4, 1.5) */
	...
	/** Safety against full plasticity hub (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Safety against full plasticity shaft (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Safety against sliding (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Shaft safety against cracking (Versions: 1.3, 1.4, 1.5) */
	...
	/** Safety factor deflection (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Shaft safety against fatigue fracture (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tooth flank safety factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Safety factor pitting (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Safety factor pitting (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Shaft safety against plastic deformation (Versions: 1.3, 1.4, 1.5) */
	...
	/** Safety factor root (DIN 3990 1987) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tooth root safety factor for peak loads (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tooth root safety factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Safety factor root (DIN 3996 2019) with wear (Versions: 1.4, 1.5) */
	...
	/** Safety factor root (DIN 3996 2019) without wear (Versions: 1.4, 1.5) */
	...
	/** Safety factor tooth root (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Scuffing risk (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Semi-width of the Hertzian contact band of the calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Sequence number (Versions: 1.5) */
	public static final RexsAttributeId sequence_number = RexsAttributeId.create("sequence_number", RexsUnitId.none);

	/** Ids of the associated point/element list (Versions: 1.4, 1.5) */
	...
	/** Inner shaft diameter for the operating clearance calculation (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId shaft_inner_diameter = RexsAttributeId.create("shaft_inner_diameter", RexsUnitId.mm);

	/** Shaft safety against plastic deformation at equivalent torque (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Shaft safety against plastic deformation at maximum torque (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Surface roughness of shaft (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Shape of helix crowning (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Shape of profile crowning (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Shear stress at tooth root (DIN 3996 2019) with wear (Versions: 1.4, 1.5) */
	...
	/** Shear stress at tooth root (DIN 3996 2019) without wear (Versions: 1.4, 1.5) */
	...
	/** Maximum length of outer ring contact (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Size factor (pitting) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Size factor pitting (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Size factor tooth root (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Sliding velocity at reference diameter (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Sliding velocitiy at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Sliding velocity at the calculation points (Versions: 1.3, 1.4, 1.5) */
	...
	/** Sliding velocity in profile direction at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Sliding velocity in tooth lengthwise direction at the mean point (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Small outer diameter with shouldered hub (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Smoothing factor (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** S/N curve application (Versions: 1.4, 1.5) */
	public static final RexsAttributeId sn_curve_application = RexsAttributeId.create("sn_curve_application", RexsUnitId.none);

	/** Span measurement (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId span_measurement = RexsAttributeId.create("span_measurement", RexsUnitId.mm);

	/** Specific film thickness with a cutoff wavelength equal to the Hertzian contact width at the calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Specific sliding (tooth root) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Specific sliding (tooth tip) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Specify tangential transition area (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Speed factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Speed rolling element set / cage (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Spiral angle factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Direction of the spiral angle (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Standard deviation of the minimum specific film thickness (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Standard deviation for the permissible stress at the point between limited life and long life (Versions: 1.4, 1.5) */
	...
	/** Start factor (Versions: 1.3, 1.4, 1.5) */
	...
	/** Start-up time (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Is cast material and bending loaded (Versions: 1.4, 1.5) */
	...
	/** Is the component rolled and is the area under consideration stressed mainly transverse to the main machining direction (Versions: 1.4, 1.5) */
	...
	/** Static load safety (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId static_load_safety = RexsAttributeId.create("static_load_safety", RexsUnitId.none);

	/** Probability of the occurrence of all maxima at the same time (Versions: 1.4, 1.5) */
	...
	/** Static overload factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Static supporting effect bending (Versions: 1.3, 1.4, 1.5) */
	...
	/** Static supporting effect tension/ compression (Versions: 1.3, 1.4, 1.5) */
	...
	/** Static supporting effect torsion (Versions: 1.3, 1.4, 1.5) */
	...
	/** Stress amplitude bending (Versions: 1.3, 1.4, 1.5) */
	...
	/** Stress amplitude tosion/ compression (Versions: 1.3, 1.4, 1.5) */
	...
	/** Stress amplitude torsion (Versions: 1.3, 1.4, 1.5) */
	...
	/** Stress correction factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Stress correction factor notch effect (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Stress correction factor for the dimensions of standard test gear (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Strength stress correction factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Stress correction factor for load application at tooth tip (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Circumferential angle of struts of planet carrier (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Inner diameter of struts of planet carrier (Versions: 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId strut_inner_diameter = RexsAttributeId.create("strut_inner_diameter", RexsUnitId.mm);

	/** Radius of planet recess in the struts of the planet carrier (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Sum of addendum modification coefficients (profile shift coefficients) (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Sum of velocities at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Sum of velocities in lengthwise direction (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Sum of velocities in profile direction at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Sum of velocities vertical to the contact line at contact point Y (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Supporting length of the hub keyway (Versions: 1.4, 1.5) */
	...
	/** Supporting length of the shaft keyway (Versions: 1.4, 1.5) */
	...
	/** Width of the large diameter hub part within the supporting length of the key (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Surface hardness - Brinell (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Surface hardness - Rockwell (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Surface hardness - Vickers (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Surface roughness factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Surface treatment category (DIN 743 2012) (Versions: 1.4, 1.5) */
	...
	/** Surface treatment factor (Versions: 1.4, 1.5) */
	...
	/** Surface velocity in lengthwise direction (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Surface velocity vertical to the contact line (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Surface zone bending resistance (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Surface zone tension resistance (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Surface zone torsion resistance (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Survival probability (Versions: 1.5) */
	public static final RexsAttributeId survival_probability = RexsAttributeId.create("survival_probability", RexsUnitId.percent);
	...
	/** Swivel motion coefficients (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tangential velocity at pitch circle (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tangential velocity at reference circle (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Technological size factor tensile strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Technological size factor yield strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Temperature coefficient a_Tt for tensile strength FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Temperature coefficient a_Tt for yield strength FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Temperature coefficient b_Tt for tensile strength FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Temperature coefficient b_Tt for yield strength FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Temperature coefficient c_Tt for tensile strength FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Temperature coefficient c_Tt for yield strength FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Temperature constant C for tensile strength FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Temperature constant C for yield strength FKM 2012 (Versions: 1.4, 1.5) */
	...
	/** Temperature-dependent modulus of elasticity (Versions: 1.3, 1.4, 1.5) */
	...
	/** Temperature dependent poisson's ratio (Versions: 1.3, 1.4, 1.5) */
	...
	/** Temperature-dependent yield strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Temperature factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Operating temperature of lubricant (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Temperature safety factor (Versions: 1.3, 1.4, 1.5) */
	...
	/** Temperature under static load (Versions: 1.4, 1.5) */
	...
	/** Temperature variation for modulus of elasticity (Versions: 1.3, 1.4, 1.5) */
	...
	/** Temperature variation for poisson's ratio (Versions: 1.3, 1.4, 1.5) */
	...
	/** Temperature variation for yield strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tension/ compression yield strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Thermal contact coefficient (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Thermal expansion coefficient (-) (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Tooth thickness modification coefficient (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Throat radius (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tilt motion coefficients (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tip diameter of virtual cylindrical gear in normal section (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Tip diameter of virtual cylindrical gear (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Diameter at start of tip relief (reference diameter) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where tangential transition area of linear tip relief starts (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Tip relief factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Tip relief height (Versions: 1.3, 1.4, 1.5) */
	...
	/** Length of tangential transition area end of linear tip relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of tangential transition area start of linear tip relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Tip relief radius (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tolerance zone of base tangent length acc. to DIN 5480 (Versions: 1.4, 1.5) */
	...
	/** Tolerance class according to ISO 1328 (2013) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tolerance field of root diameter acc .to DIN 5480 (Versions: 1.4, 1.5) */
	...
	/** Tolerance zone of tip circle diameter acc. to DIN 5480 (Versions: 1.4, 1.5) */
	...
	/** Tool profile position (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tool tip height (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tooth addendum (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tooth form factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Tooth root stress (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Tooth temperature (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tooth temperature of test gears (AGMA 925 C95) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Tooth thickness (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** DIN 3967 Deviation-tolerance series (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Tooth thickness half angle at active root diameter (Versions: 1.5) */
	public static final RexsAttributeId tooth_thickness_half_angle_at_active_root_diameter = RexsAttributeId.create("tooth_thickness_half_angle_at_active_root_diameter", RexsUnitId.deg);

	/** Tooth thickness half angle at active tip diameter (Versions: 1.5) */
	public static final RexsAttributeId tooth_thickness_half_angle_at_active_tip_diameter = RexsAttributeId.create("tooth_thickness_half_angle_at_active_tip_diameter", RexsUnitId.deg);

	/** Tooth thickness half angle at base diameter (Versions: 1.5) */
	public static final RexsAttributeId tooth_thickness_half_angle_at_base_diameter = RexsAttributeId.create("tooth_thickness_half_angle_at_base_diameter", RexsUnitId.deg);

	/** Tooth thickness half angle at pitch diameter (Versions: 1.5) */
	public static final RexsAttributeId tooth_thickness_half_angle_at_pitch_diameter = RexsAttributeId.create("tooth_thickness_half_angle_at_pitch_diameter", RexsUnitId.deg);

	/** Tooth thickness half angle at reference diameter (Versions: 1.5) */
	public static final RexsAttributeId tooth_thickness_half_angle_at_reference_diameter = RexsAttributeId.create("tooth_thickness_half_angle_at_reference_diameter", RexsUnitId.deg);

	/** Tooth thickness half angle at root diameter (Versions: 1.5) */
	public static final RexsAttributeId tooth_thickness_half_angle_at_root_diameter = RexsAttributeId.create("tooth_thickness_half_angle_at_root_diameter", RexsUnitId.deg);

	/** Tooth thickness half angle at root form diameter (Versions: 1.5) */
	public static final RexsAttributeId tooth_thickness_half_angle_at_root_form_diameter = RexsAttributeId.create("tooth_thickness_half_angle_at_root_form_diameter", RexsUnitId.deg);

	/** Tooth thickness half angle at tip diameter (Versions: 1.5) */
	public static final RexsAttributeId tooth_thickness_half_angle_at_tip_diameter = RexsAttributeId.create("tooth_thickness_half_angle_at_tip_diameter", RexsUnitId.deg);

	/** Tooth thickness half angle at tip form diameter (Versions: 1.5) */
	public static final RexsAttributeId tooth_thickness_half_angle_at_tip_form_diameter = RexsAttributeId.create("tooth_thickness_half_angle_at_tip_form_diameter", RexsUnitId.deg);

	/** Tooth thickness loss (DIN 3996 2019) (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Topographical deviation amounts (Versions: 1.4, 1.5) */
	...
	/** Normal direction of topographical deviation (Versions: 1.4, 1.5) */
	...
	/** Amount of topographical modification (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Transmitted torque (with sign) (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId torque = RexsAttributeId.create("torque", RexsUnitId.newton_m);

	/** Torque around u-axis acting on the component on the inner side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque around v-axis acting on the component on the inner side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque around w-axis acting on the component on the inner side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque around u-axis acting on the component on the outer side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque around v-axis acting on the component on the outer side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque around w-axis acting on the component on the outer side (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque around u-axis acting on the shaft (Versions: 1.4, 1.5) */
	...
	/** Torque around v-axis acting on the shaft (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque around w-axis acting on the shaft (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque around the v-axis (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque around the w-axis (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque with sign (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque distribution around the u-axis (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque distribution around the v-axis (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Torque distribution around the w-axis (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Maximum torsional torque (Versions: 1.3, 1.4, 1.5) */
	...
	/** Stress ratio of the torsional torque (Versions: 1.3, 1.4, 1.5) */
	...
	/** Upper value torsional torque (Versions: 1.3, 1.4, 1.5) */
	...
	/** Torsion around the u-axis (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId torsion_u = RexsAttributeId.create("torsion_u", RexsUnitId.deg);

	/** Torsional yield strength (Versions: 1.3, 1.4, 1.5) */
	...
	/** Total frictional torque (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Total pitch deviation (Versions: 1.4, 1.5) */
	...
	/** Tooth force in u-direction (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Tooth force in v-direction (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Tooth force in w-direction (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Load transmits torque (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId transmits_torque = RexsAttributeId.create("transmits_torque", RexsUnitId.none);

	/** Transmittable axial force (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Transmittable torque (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Transverse base pitch (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId transverse_base_pitch = RexsAttributeId.create("transverse_base_pitch", RexsUnitId.mm);

	/** Transverse circular pitch on reference circle (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Transverse load factor flank (DIN 3990 1987) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Transverse load factor (ISO 6336 2006) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Transverse load factor pitting (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Transverse load factor tooth root (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Transverse radius of curvature at point B (Versions: 1.4, 1.5) */
	...
	/** Transverse radius of curvature at point C (Versions: 1.4, 1.5) */
	...
	/** Transverse radius of curvature at point D (Versions: 1.4, 1.5) */
	...
	/** Transverse radius of curvature at point E (Versions: 1.4, 1.5) */
	...
	/** Transverse radius of curvature at the calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Transverse radius of relative curvature at point A (Versions: 1.4, 1.5) */
	...
	/** Transverse radius of relative curvature at point B (Versions: 1.4, 1.5) */
	...
	/** Transverse radius of relative curvature at point C (Versions: 1.4, 1.5) */
	...
	/** Transverse radius of relative curvature at point D (Versions: 1.4, 1.5) */
	...
	/** Transverse radius of relative curvature at point E (Versions: 1.4, 1.5) */
	...
	/** Transverse relative radius of curvature of calculation points (AGMA 925 A03) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Transverse tooth thickness at active root diameter (Versions: 1.5) */
	public static final RexsAttributeId transverse_tooth_thickness_at_active_root_diameter = RexsAttributeId.create("transverse_tooth_thickness_at_active_root_diameter", RexsUnitId.mm);

	/** Transverse tooth thickness at active tip diameter (Versions: 1.5) */
	public static final RexsAttributeId transverse_tooth_thickness_at_active_tip_diameter = RexsAttributeId.create("transverse_tooth_thickness_at_active_tip_diameter", RexsUnitId.mm);

	/** Transverse tooth thickness at pitch diameter (Versions: 1.5) */
	public static final RexsAttributeId transverse_tooth_thickness_at_pitch_diameter = RexsAttributeId.create("transverse_tooth_thickness_at_pitch_diameter", RexsUnitId.mm);

	/** Transverse tooth thickness at reference diameter (Versions: 1.5) */
	public static final RexsAttributeId transverse_tooth_thickness_at_reference_diameter = RexsAttributeId.create("transverse_tooth_thickness_at_reference_diameter", RexsUnitId.mm);

	/** Transverse tooth thickness at root diameter (Versions: 1.5) */
	public static final RexsAttributeId transverse_tooth_thickness_at_root_diameter = RexsAttributeId.create("transverse_tooth_thickness_at_root_diameter", RexsUnitId.mm);

	/** Transverse tooth thickness at root form diameter (Versions: 1.5) */
	public static final RexsAttributeId transverse_tooth_thickness_at_root_form_diameter = RexsAttributeId.create("transverse_tooth_thickness_at_root_form_diameter", RexsUnitId.mm);

	/** Transverse tooth thickness at tip diameter (Versions: 1.5) */
	public static final RexsAttributeId transverse_tooth_thickness_at_tip_diameter = RexsAttributeId.create("transverse_tooth_thickness_at_tip_diameter", RexsUnitId.mm);

	/** Transverse tooth thickness at tip form diameter (Versions: 1.5) */
	public static final RexsAttributeId transverse_tooth_thickness_at_tip_form_diameter = RexsAttributeId.create("transverse_tooth_thickness_at_tip_form_diameter", RexsUnitId.mm);

	/** Diameter of begin of triangular root relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of triangular root relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Depth of triangular root relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where tangential transition area of triangular root relief ends (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where tangential transition area of triangular root relief starts (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where amount of triangular root relief is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Rolling length where amount of triangular root relief is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of tangential transition area of triangular root relief end (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of tangential transition area of triangular root relief start (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter of begin of triangular tip relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of triangular tip relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Depth of triangular tip relief (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where tangential transition area of triangular tip relief ends (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where tangential transition area of triangular tip relief starts (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Diameter where amount of triangular tip relief is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Rolling length where amount of triangular tip relief is specified (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of tangential transition area of triangular tip relief end (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Length of tangential transition area of triangular tip relief start (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Type of centering (DIN 5480 2006) (Versions: 1.4, 1.5) */
	...
	/** Type of feather key according to DIN 6885 (Versions: 1.4, 1.5) */
	...
	/** Type of gear casing construction (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Type of interpolation (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Outer side: u-coordinate on shaft (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** U coordinates of beam nodes (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Upper base tangent length deviation (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Upper centre distance allowance (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Usable addendum circle diameter (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Usable root circle diameter (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Utilization of yield strength (DIN 7190 2017) (Versions: 1.4, 1.5) */
	...
	/** Utilized addendum coefficient reference profile (Versions: 1.4, 1.5) */
	...
	/** Utilized addendum reference profile (Versions: 1.4, 1.5) */
	...
	/** Utilized dedenudum coefficient reference profile (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Utilized dedendum reference profile (Versions: 1.0, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Velocity factor (pitting) (Versions: 1.3, 1.4, 1.5) */
	...
	public static final RexsAttributeId version = RexsAttributeId.create("version", RexsUnitId.none);

	/** Vertical motion coefficients (Versions: 1.3, 1.4, 1.5) */
	...
	/** Virtual number of teeth (Versions: 1.2, 1.3, 1.4, 1.5) */
	...
	/** Viscosity at 100&deg;C (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Viscosity at 40&deg;C (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Viscosity ratio according to ISO 281 2007 (Versions: 1.1, 1.2, 1.3, 1.4, 1.5) */
	...
	/** Wear erosion (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Wear intensity (Versions: 1.3, 1.4, 1.5) */
	...
	/** Wear life (Plewe 1980) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Wear safety factor (pointed tooth) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Wheel bulk temperature (Versions: 1.3, 1.4, 1.5) */
	...
	/** Bearing width (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId width = RexsAttributeId.create("width", RexsUnitId.mm);

	/** Width of large outer diameter with shouldered hub (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Offset of width (Versions: 1.3, 1.4, 1.5) */
	public static final RexsAttributeId width_offset = RexsAttributeId.create("width_offset", RexsUnitId.mm);

	/** Width of small outer diameter with shouldered hub (DIN 6892 2012) (Versions: 1.4, 1.5) */
	...
	/** Width to pitch diameter ratio (Versions: 1.3, 1.4, 1.5) */
	...
	/** Width to normal module ratio (Versions: 1.3, 1.4, 1.5) */
	...
	/** Work hardening factor (ISO 10300 2014) (Versions: 1.4, 1.5) */
	...
	/** Material depth of maximum hardness (ISO 6336 2019) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Yield strength (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5) */
	public static final RexsAttributeId yield_strength = RexsAttributeId.create("yield_strength", RexsUnitId.newton_per_mm2);

	/** Yield strength at operating temperature (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
	...
	/** Yield strength of component (Versions: 1.4, 1.5) */
	...
	/** Zone factor (VDI 2736 2014) (Versions: 1.3, 1.4, 1.5) */
