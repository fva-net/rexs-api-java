...
public interface RexsStandardAttributeIds {
	...
	public static final RexsAttributeId ambient_pressure_plain_bearing = RexsAttributeId.create("ambient_pressure_plain_bearing", RexsUnitId.newton_per_mm2);

	/** Axial journal ambient temperature (front) (Versions: 1.6) */
	public static final RexsAttributeId ambient_temperature_journal_front_plain_bearing = RexsAttributeId.create("ambient_temperature_journal_front_plain_bearing", RexsUnitId.degree_celsius);

	/** Axial journal ambient temperature (rear) (Versions: 1.6) */
	public static final RexsAttributeId ambient_temperature_journal_rear_plain_bearing = RexsAttributeId.create("ambient_temperature_journal_rear_plain_bearing", RexsUnitId.degree_celsius);

	/** Axial bearing shell ambient temperature (front) (Versions: 1.6) */
	public static final RexsAttributeId ambient_temperature_shell_front_plain_bearing = RexsAttributeId.create("ambient_temperature_shell_front_plain_bearing", RexsUnitId.degree_celsius);

	/** Radial bearing shell ambient temperature (Versions: 1.6) */
	public static final RexsAttributeId ambient_temperature_shell_radial_plain_bearing = RexsAttributeId.create("ambient_temperature_shell_radial_plain_bearing", RexsUnitId.degree_celsius);

	/** Axial bearing shell ambient temperature (rear) (Versions: 1.6) */
	public static final RexsAttributeId ambient_temperature_shell_rear_plain_bearing = RexsAttributeId.create("ambient_temperature_shell_rear_plain_bearing", RexsUnitId.degree_celsius);
	...
	public static final RexsAttributeId angular_position_center_of_curvatue = RexsAttributeId.create("angular_position_center_of_curvatue", RexsUnitId.deg);
	...
	public static final RexsAttributeId axial_position_of_plain_bearing_feature = RexsAttributeId.create("axial_position_of_plain_bearing_feature", RexsUnitId.mm);
	...
	public static final RexsAttributeId bearing_ring_type = RexsAttributeId.create("bearing_ring_type", RexsUnitId.none);
	...
	public static final RexsAttributeId body_contour_coordinate_u = RexsAttributeId.create("body_contour_coordinate_u", RexsUnitId.mm);

	/** Contour coordinates v (Versions: 1.6) */
	public static final RexsAttributeId body_contour_coordinate_v = RexsAttributeId.create("body_contour_coordinate_v", RexsUnitId.mm);

	/** Contour radius (Versions: 1.6) */
	public static final RexsAttributeId body_contour_element_radius = RexsAttributeId.create("body_contour_element_radius", RexsUnitId.mm);

	/** Contour element type (Versions: 1.6) */
	public static final RexsAttributeId body_contour_element_type = RexsAttributeId.create("body_contour_element_type", RexsUnitId.none);
	...
	public static final RexsAttributeId contact_area = RexsAttributeId.create("contact_area", RexsUnitId.mm2);
	...
	public static final RexsAttributeId contact_force = RexsAttributeId.create("contact_force", RexsUnitId.newton);
	...
	public static final RexsAttributeId diameter_clearance_plain_bearing = RexsAttributeId.create("diameter_clearance_plain_bearing", RexsUnitId.none);

	/** Diameter of the cylindrical surface of the contact (Versions: 1.6) */
	public static final RexsAttributeId diameter_of_cylindrical_surface_contact = RexsAttributeId.create("diameter_of_cylindrical_surface_contact", RexsUnitId.mm);
	...
	public static final RexsAttributeId dynamic_equivalent_reference_bearing_load_iso_16281_2008 = RexsAttributeId.create("dynamic_equivalent_reference_bearing_load_iso_16281_2008", RexsUnitId.newton);
	...
	public static final RexsAttributeId end_angle_plain_bearing_feature = RexsAttributeId.create("end_angle_plain_bearing_feature", RexsUnitId.deg);
	...
	public static final RexsAttributeId feed_pressure_plain_bearing = RexsAttributeId.create("feed_pressure_plain_bearing", RexsUnitId.newton_per_mm2);
	...
	public static final RexsAttributeId fill_ratio_plain_bearing_feature = RexsAttributeId.create("fill_ratio_plain_bearing_feature", RexsUnitId.none);
	...
	public static final RexsAttributeId gear_body_rim_thickness = RexsAttributeId.create("gear_body_rim_thickness", RexsUnitId.mm);

	/** Gear body web thickness (Versions: 1.6) */
	public static final RexsAttributeId gear_body_web_thickness = RexsAttributeId.create("gear_body_web_thickness", RexsUnitId.mm);
	...
	public static final RexsAttributeId heat_transfer_coefficient_at_journal_front_plain_bearing = RexsAttributeId.create("heat_transfer_coefficient_at_journal_front_plain_bearing", RexsUnitId.unit_60);

	/** Axial heat transfer coefficient between journal and environment (rear) (Versions: 1.6) */
	public static final RexsAttributeId heat_transfer_coefficient_at_journal_rear_plain_bearing = RexsAttributeId.create("heat_transfer_coefficient_at_journal_rear_plain_bearing", RexsUnitId.unit_60);

	/** Axial heat transfer coefficient between bearing shell and environment (front) (Versions: 1.6) */
	public static final RexsAttributeId heat_transfer_coefficient_front_plain_bearing = RexsAttributeId.create("heat_transfer_coefficient_front_plain_bearing", RexsUnitId.unit_60);
	...
	public static final RexsAttributeId heat_transfer_coefficient_radial_plain_bearing = RexsAttributeId.create("heat_transfer_coefficient_radial_plain_bearing", RexsUnitId.unit_60);

	/** Axial heat transfer coefficient between bearing shell and environment (rear) (Versions: 1.6) */
	public static final RexsAttributeId heat_transfer_coefficient_rear_plain_bearing = RexsAttributeId.create("heat_transfer_coefficient_rear_plain_bearing", RexsUnitId.unit_60);
	...
	public static final RexsAttributeId is_isothermal_calculation = RexsAttributeId.create("is_isothermal_calculation", RexsUnitId.none);
	...
	public static final RexsAttributeId is_pressurized = RexsAttributeId.create("is_pressurized", RexsUnitId.none);
	...
	public static final RexsAttributeId level_of_detail = RexsAttributeId.create("level_of_detail", RexsUnitId.none);
	...
	public static final RexsAttributeId life_modification_factor_reliability_iso_281_2007 = RexsAttributeId.create("life_modification_factor_reliability_iso_281_2007", RexsUnitId.none);

	/** Effective life modification factor system approach ISO/TS 16281 2008 (Versions: 1.6) */
	public static final RexsAttributeId life_modification_factor_system_approach_effective_iso_16281_2008 = RexsAttributeId.create("life_modification_factor_system_approach_effective_iso_16281_2008", RexsUnitId.none);

	/** Maximum life modification factor system approach ISO/TS 16281 2008 (Versions: 1.6) */
	public static final RexsAttributeId life_modification_factor_system_approach_maximum_iso_16281_2008 = RexsAttributeId.create("life_modification_factor_system_approach_maximum_iso_16281_2008", RexsUnitId.none);

	/** Minimum life modification factor system approach ISO/TS 16281 2008 (Versions: 1.6) */
	public static final RexsAttributeId life_modification_factor_system_approach_minimum_iso_16281_2008 = RexsAttributeId.create("life_modification_factor_system_approach_minimum_iso_16281_2008", RexsUnitId.none);
	...
	public static final RexsAttributeId lubricant_feed_temperature = RexsAttributeId.create("lubricant_feed_temperature", RexsUnitId.degree_celsius);
	...
	public static final RexsAttributeId lubricant_side = RexsAttributeId.create("lubricant_side", RexsUnitId.none);
	...
	public static final RexsAttributeId modifications_of_diameter_clearance_point_list = RexsAttributeId.create("modifications_of_diameter_clearance_point_list", RexsUnitId.mum);
	...
	public static final RexsAttributeId modified_rating_life_rotations_iso_281_2007 = RexsAttributeId.create("modified_rating_life_rotations_iso_281_2007", RexsUnitId.unit_59);

	/** Modified rating life (ISO 281 2007) (Versions: 1.6) */
	public static final RexsAttributeId modified_rating_life_time_iso_281_2007 = RexsAttributeId.create("modified_rating_life_time_iso_281_2007", RexsUnitId.hour);

	/** Modified reference rating life DIN 26281 2010 (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsAttributeId modified_reference_rating_life_rotations_din_26281 = RexsAttributeId.create("modified_reference_rating_life_rotations_din_26281", RexsUnitId.unit_59);
	...
	public static final RexsAttributeId mounting_angle_plain_bearing = RexsAttributeId.create("mounting_angle_plain_bearing", RexsUnitId.deg);
	...
	public static final RexsAttributeId nominal_rating_life_rotations_iso_281_2007 = RexsAttributeId.create("nominal_rating_life_rotations_iso_281_2007", RexsUnitId.unit_59);
	...
	public static final RexsAttributeId nominal_reference_rating_life_rotations_din_26281 = RexsAttributeId.create("nominal_reference_rating_life_rotations_din_26281", RexsUnitId.unit_59);
	...
	public static final RexsAttributeId point_coordinates_angle_about_u_axis = RexsAttributeId.create("point_coordinates_angle_about_u_axis", RexsUnitId.deg);

	/** Point coordinates - angle to u axis (Versions: 1.6) */
	public static final RexsAttributeId point_coordinates_angle_to_u_axis = RexsAttributeId.create("point_coordinates_angle_to_u_axis", RexsUnitId.deg);

	/** Point coordinates - radius (Versions: 1.6) */
	public static final RexsAttributeId point_coordinates_radius = RexsAttributeId.create("point_coordinates_radius", RexsUnitId.mm);

	/** Point coordinates - u coordinate (Versions: 1.6) */
	public static final RexsAttributeId point_coordinates_u_coord = RexsAttributeId.create("point_coordinates_u_coord", RexsUnitId.mm);
	...
	public static final RexsAttributeId preload_distance_surface_contact = RexsAttributeId.create("preload_distance_surface_contact", RexsUnitId.mum);
	...
	public static final RexsAttributeId preload_running_surface_plain_bearing = RexsAttributeId.create("preload_running_surface_plain_bearing", RexsUnitId.none);
	...
	public static final RexsAttributeId profile_curvature_diameter_plain_bearing = RexsAttributeId.create("profile_curvature_diameter_plain_bearing", RexsUnitId.mm);
	...
	public static final RexsAttributeId profiling_plain_bearing = RexsAttributeId.create("profiling_plain_bearing", RexsUnitId.none);
	...
	public static final RexsAttributeId reference_diameter_relative_clearance_plain_bearing = RexsAttributeId.create("reference_diameter_relative_clearance_plain_bearing", RexsUnitId.mm);
	...
	public static final RexsAttributeId relative_clearance_plain_bearing = RexsAttributeId.create("relative_clearance_plain_bearing", RexsUnitId.percent);
	...
	public static final RexsAttributeId relative_eccentricity_plain_bearing = RexsAttributeId.create("relative_eccentricity_plain_bearing", RexsUnitId.none);
	...
	public static final RexsAttributeId starting_angle_plain_bearing_feature = RexsAttributeId.create("starting_angle_plain_bearing_feature", RexsUnitId.deg);
	...
	public static final RexsAttributeId type_of_surface_contact = RexsAttributeId.create("type_of_surface_contact", RexsUnitId.none);
