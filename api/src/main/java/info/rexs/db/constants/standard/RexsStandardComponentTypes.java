 ...
 * <p>
 * It contains constants for all component types of official REXS versions (1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6).
 *
 * @author FVA GmbH
 */
public interface RexsStandardComponentTypes {

	/** Additional mass (Versions: 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType additional_mass = RexsComponentType.create("additional_mass");

	/** Assembly group (Versions: 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType assembly_group = RexsComponentType.create("assembly_group");

	/** Bearing ring (Versions: 1.6) */
	public static final RexsComponentType bearing_ring = RexsComponentType.create("bearing_ring");

	/** Bevel gear (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType bevel_gear = RexsComponentType.create("bevel_gear");

	/** Flank of bevel gear (Versions: 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType bevel_gear_flank = RexsComponentType.create("bevel_gear_flank");

	/** Bevel gear manufacturing settings (Versions: 1.3, 1.4, 1.5, 1.6) */
	...
	/** FKM evaluation point (Versions: 1.4, 1.5, 1.6) */
	...
	/** Gear body (Versions: 1.6) */
	public static final RexsComponentType gear_body = RexsComponentType.create("gear_body");

	/** Gear casing (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType gear_casing = RexsComponentType.create("gear_casing");

	/** Gear flank data of a point list (Versions: 1.4, 1.5, 1.6) */
	public static final RexsComponentType gear_flank_data_set = RexsComponentType.create("gear_flank_data_set");

	/** Gear root data of a point list (Versions: 1.4, 1.5, 1.6) */
	public static final RexsComponentType gear_root_data_set = RexsComponentType.create("gear_root_data_set");

	/** Gear unit (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	...
	/** Meshing contact stage data of a point list (Versions: 1.4, 1.5, 1.6) */
	...
	/** Notch effect of shaft-hub-connection (Versions: 1.4, 1.5, 1.6) */
	...
	/** Planetary carrier (Versions: 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType planet_carrier = RexsComponentType.create("planet_carrier");

	/** Planetary stage (Versions: 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType planetary_stage = RexsComponentType.create("planetary_stage");

	/** Point list (Versions: 1.4, 1.5, 1.6) */
	public static final RexsComponentType point_list = RexsComponentType.create("point_list");

	/** Profile crowning (Versions: 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType profile_crowning = RexsComponentType.create("profile_crowning");

	/** Profile deviation (Versions: 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType profile_deviation = RexsComponentType.create("profile_deviation");

	/** Profile slope modification (Versions: 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType profile_slope = RexsComponentType.create("profile_slope");

	/** Profile twist (Versions: 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType profile_twist = RexsComponentType.create("profile_twist");

	/** Rack-shaped tool (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType rack_shaped_tool = RexsComponentType.create("rack_shaped_tool");

	/** Plain bearing groove (Versions: 1.6) */
	public static final RexsComponentType radial_plain_bearing_groove = RexsComponentType.create("radial_plain_bearing_groove");

	/** Plain bearing hole (Versions: 1.6) */
	public static final RexsComponentType radial_plain_bearing_hole = RexsComponentType.create("radial_plain_bearing_hole");

	/** Plain bearing profile (Versions: 1.6) */
	public static final RexsComponentType radial_plain_bearing_profile = RexsComponentType.create("radial_plain_bearing_profile");

	/** Plain bearing profiel data set (Versions: 1.6) */
	public static final RexsComponentType radial_plain_bearing_profile_data_set = RexsComponentType.create("radial_plain_bearing_profile_data_set");

	/** Plain bearing shell (Versions: 1.6) */
	public static final RexsComponentType radial_plain_bearing_shell = RexsComponentType.create("radial_plain_bearing_shell");

	/** Plain bearing slot (Versions: 1.6) */
	public static final RexsComponentType radial_plain_bearing_slot = RexsComponentType.create("radial_plain_bearing_slot");

	/** Rectangular groove (Versions: 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType rectangular_groove = RexsComponentType.create("rectangular_groove");

	/** Reduction point (Versions: 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType reduction_point = RexsComponentType.create("reduction_point");

	/** Ring gear (Versions: 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType ring_gear = RexsComponentType.create("ring_gear");

	/** Rolling bearing row (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType rolling_bearing_row = RexsComponentType.create("rolling_bearing_row");

	/** Rolling bearing with catalog data (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	...
	/** Rolling bearing with detailed geometry (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	...
	/** Rolling element (Versions: 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6) */
	public static final RexsComponentType rolling_element = RexsComponentType.create("rolling_element");

	/** Rolling element contact (Versions: 1.3, 1.4, 1.5, 1.6) */
