 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{}roleChange" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "roleChanges")
public class RoleChanges {

    @XmlElement(required = true)
    protected List<RoleChange> roleChange;
     ...
     *
     */
    public List<RoleChange> getRoleChange() {
        if (roleChange == null) {
            roleChange = new ArrayList<RoleChange>();
        }
