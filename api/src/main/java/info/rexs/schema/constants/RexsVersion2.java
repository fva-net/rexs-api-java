...
public class RexsVersion2 {
	 ...
	 */
	public int compareTo(RexsVersion2 other) {
	 ...
	 */
	public boolean isLessThan(RexsVersion2 other) {
	 ...
	 */
	public boolean isLessThanOrEquivalentTo(RexsVersion2 other) {
		return this.compareTo(other) <= 0;
	}
	 ...
	 */
	public boolean isGreaterThan(RexsVersion2 other) {
		return this.compareTo(other) > 0;
	}
	 ...
	 */
	public boolean isGreaterThanOrEquivalentTo(RexsVersion2 other) {
		return this.compareTo(other) >= 0;
	}
	 ...
	 */
	public boolean isEquivalentTo(RexsVersion2 other) {
		return this.compareTo(other) == 0;
	}
